...
/* will accept string or array of numbers, 
   if your string is Unicode (UTF-8,..) convert it first using the "unicode_to_ascii" method, then use crc32 (ascii_to_unicode is here just in case..)
 */
...
(function(){
  console.log( 
    crc32(unicode_to_ascii("אלעד")) 
  , crc32([215, 144, 215, 156, 215, 162, 215, 147])
  );  
}());
